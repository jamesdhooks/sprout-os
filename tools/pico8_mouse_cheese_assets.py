...
def build(sprites,title,preview,reference=None):
 ...
 alternate_y={14:80,9:96,7:108,5:116}
 for size,y in ((14,0),(9,16),(7,32),(5,40)):
  ...
  piece=cheese.copy(); piece.thumbnail((size,size),Image.Resampling.NEAREST)
  canvas=Image.new("RGBA",(size,size),(0,0,0,0)); canvas.alpha_composite(piece,((size-piece.width)//2,(size-piece.height)//2))
  stamp(canvas,pixels,64,y)
