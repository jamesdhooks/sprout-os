...
Start with the [getting-started guide](docs/development/getting-started.md), [Sprout Arcade guide](docs/arcade/README.md), [PICO-8 game guide](docs/development/pico8-game-development.md), [runtime guide](docs/runtime/README.md), [architecture overview](docs/architecture/overview.md), [visual system](docs/architecture/visual-system.md), and relevant [architecture decisions](docs/decisions/).
