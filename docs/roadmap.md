...
| [Sprout Arcade Windows Preview](https://github.com/jamesdhooks/sprout-os/milestone/2) | Complete | The launcher discovers and starts one packaged native microgame through a deterministic Windows runtime, with automated package, lifecycle, storage, event, and return evidence |
| [Sprout Arcade Engine and First Three Games](https://github.com/jamesdhooks/sprout-os/milestone/3) | In progress | Mouse & Cheese Maze, Blocks & Buttons, and Snake are complete Windows packages using shared engine, content, asset, persistence, progression, and lifecycle systems |
