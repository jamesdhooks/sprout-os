...
| [Sprout Family Launcher MVP](https://github.com/jamesdhooks/sprout-os/milestone/1) | In progress | A development SD card completes the profile-to-launch-to-return vertical slice with local policy and recovery |
